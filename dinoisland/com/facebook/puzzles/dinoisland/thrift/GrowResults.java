 ...
 */
public class GrowResults implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("GrowResults");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(GrowResults.class, metaDataMap);
  }
   ...
   */
  public GrowResults(GrowResults other) {
  ...
  @Override
  public GrowResults clone() {
    return new GrowResults(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GrowResults)
      return this.equals((GrowResults)that);
    return false;
  }

  public boolean equals(GrowResults that) {
    if (that == null)
      return false;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GrowResults(");
    boolean first = true;
